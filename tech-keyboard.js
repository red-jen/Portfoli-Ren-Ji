...
class TechKeyboard {
  constructor(containerId = 'tech-keyboard-container') {
    ...
    this.techStack = [
      ...
      { name: 'Express.js', color: 0x000000, label: '', icon: 'express.png', position: [1.5, 0, -0.5],
        description: 'Fast, unopinionated, minimalist web framework for Node.js.' },
      
      // Fourth row
      { name: 'MySQL', color: 0x4479A1, label: '', icon: 'mysql.png', position: [-1.5, 0, -1.5],
        description: 'Open-source relational database management system.' },
      { name: 'PostgreSQL', color: 0x336791, label: '', icon: 'postgresql.png', position: [-0.5, 0, -1.5],
      ...
      { name: 'Git', color: 0xF05032, label: '', icon: 'git.png', position: [1.5, 0, -1.5],
